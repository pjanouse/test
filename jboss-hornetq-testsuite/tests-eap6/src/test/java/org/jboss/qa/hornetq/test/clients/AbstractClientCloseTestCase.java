 ...
 * <p/>
 * Point of these RFEs is adding new management operations to allow forced client disconnection either by destination address or
 * by user name.
 */
public abstract class AbstractClientCloseTestCase extends HornetQTestCase {
    ...
    public void clientForcedDisconnectTest(boolean secured, String username, ClientCloser closer) throws Exception {
        ...
        try {
            ...
            assertEquals("There should be notification for consumer creation", "CONSUMER_CREATED", notifications.get(0)
                    .getType());
            assertEquals("There should be notification for consumer destruction", "CONSUMER_CLOSED", notifications.get(1)
                    .getType());
    ...
    private ObjectName getServerControlObjectName(Container container) throws MalformedObjectNameException {

        return new ObjectName("org.hornetq:module=Core,type=Server");
    ...
    private void prepareServerEAP6(boolean secured) throws Exception {
        ...
        ops.addAddressSettings("#", "PAGE", 1024 * 1024, 1000, 1000, 500 * 1024);
    ...
    private void createUsersAndRoles() throws Exception {
        ...
        UsersSettings.forDefaultEapServer().withUser("guest", null, "guest").withUser("user", "useruser", "users")
                .withUser("admin", "adminadmin", "admins").create();
    }
    ...
    private static class TestClients {
        ...
        public void sendAndReceiveMessages(Connection connection, String queueName) throws ExecutionException,
