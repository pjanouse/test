...
public class XAConsumerTransAck extends Client {
    ...
    public void run() {
        ...
        try {
            ...
            try (XAJMSContext jmsContext = cf.createXAContext()) {
                ...
                while (!stop) {
                    ...
                    try {
                        ...
                        xaRes = jmsContext.getXAResource();
...
//                    consumer = session.createConsumer(queue);
     ...
     */
    private void receiveMessagesInXATransaction(XAResource xaRes, JMSConsumer consumer) throws Exception {
