                ...
                while ((message = receiveMessage(receiver)) != null) {
                    ...
                    if (count % ackAfter == 0) { // try to ack message
                        ...
                        logger.debug("Receiver for node: " + hostname + " and queue: " + queueNameJndi
                                ...
                                + ((message.getStringProperty(jmsImplementation.getDuplicatedHeader()) != null) ?
    ...
    public void acknowledgeMessage(Message message) throws Exception {
        ...
        while (numberOfRetries < maxRetries) {
            try {
                ...
                if (numberOfRetries == 0 && message.getStringProperty(jmsImplementation.getDuplicatedHeader()) != null && setOfReceivedMessagesWithPossibleDuplicates.size() > 0)    {
