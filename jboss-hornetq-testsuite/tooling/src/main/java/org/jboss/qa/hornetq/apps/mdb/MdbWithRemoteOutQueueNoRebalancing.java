...
public class MdbWithRemoteOutQueueNoRebalancing implements MessageListener {

    private static final long serialVersionUID = 2770941392406343837L;
    private static final Logger log = Logger.getLogger(MdbWithRemoteOutQueueNoRebalancing.class.getName());
