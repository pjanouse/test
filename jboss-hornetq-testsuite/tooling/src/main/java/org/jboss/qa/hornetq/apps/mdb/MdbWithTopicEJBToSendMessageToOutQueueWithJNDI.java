 ...
 * A MdbWithTopicEJBToSendMessageToOutQueueWithJNDI used for example lodh tests. Used in RemoteJcaWithRecoverTestCase in interop test suite.
 * <p/>
 ...
 */
@MessageDriven(name = "MdbWithTopicEJBToSendMessageToOutQueueWithJNDI",
        activationConfig = {
...
public class MdbWithTopicEJBToSendMessageToOutQueueWithJNDI implements MessageDrivenBean, MessageListener {

    private static final long serialVersionUID = 2770941392406343837L;

    private static final Logger log = Logger.getLogger(MdbWithTopicEJBToSendMessageToOutQueueWithJNDI.class.getName());
