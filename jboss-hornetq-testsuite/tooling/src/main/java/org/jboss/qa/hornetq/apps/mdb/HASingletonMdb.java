 ...
 */
@MessageDriven(name = Constants.HA_SINGLETON_MDB_NAME,
        activationConfig = {
...
@DeliveryGroup("group")
@ClusteredSingleton
public class HASingletonMdb implements MessageListener {

    private static final long serialVersionUID = 2770941392406343837L;
    private static final Logger log = Logger.getLogger(HASingletonMdb.class.getName());
