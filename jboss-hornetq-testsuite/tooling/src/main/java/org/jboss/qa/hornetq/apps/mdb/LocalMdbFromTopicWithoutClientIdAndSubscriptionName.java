...
public class LocalMdbFromTopicWithoutClientIdAndSubscriptionName implements MessageDrivenBean, MessageListener {
    ...
    private static final Logger log = Logger.getLogger(LocalMdbFromTopicWithoutClientIdAndSubscriptionName.class.getName());
    private MessageDrivenContext context = null;

    public LocalMdbFromTopicWithoutClientIdAndSubscriptionName() {
        super();
    }
