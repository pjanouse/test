...
/**
 * A MdbWithRemoteOutQueueToContainerWithReplacementPropertiesLookup used for lodh tests. Used in RemoteJcaTestCase.
 * <p/>
...
public class MdbWithRemoteOutQueueToContainerWithReplacementPropertiesName implements MessageListener {

    private static final long serialVersionUID = 2770941392406343837L;
    private static final Logger log = Logger.getLogger(MdbWithRemoteOutQueueToContainerWithReplacementPropertiesName.class.getName());
