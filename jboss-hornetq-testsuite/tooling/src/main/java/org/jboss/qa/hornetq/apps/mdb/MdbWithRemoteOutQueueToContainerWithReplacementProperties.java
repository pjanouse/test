...
/**
 * A MdbWithRemoteOutQueueToContainerWithReplacementProperties used for lodh tests. Used in RemoteJcaTestCase.
 * <p/>
...
public class MdbWithRemoteOutQueueToContainerWithReplacementProperties implements MessageListener {

    private static final long serialVersionUID = 2770941392406343837L;
    private static final Logger log = Logger.getLogger(MdbWithRemoteOutQueueToContainerWithReplacementProperties.class.getName());
    ...
    @Resource(mappedName = "${pooled.connection.factory.name}")
