...
/**
 * A MdbFromNonDurableTopicWithOutQueueToContaniner1 used for lodh tests. Used in RemoteJcaTestCase.
 * <p/>
 ...
 */
@MessageDriven(name = "MdbFromNonDurableTopicWithOutQueueToContaniner1",
        activationConfig = {
...
public class MdbFromNonDurableTopicWithOutQueueToContaniner1 implements MessageListener {

    private static final long serialVersionUID = 2770941392406343837L;
    private static final Logger log = Logger.getLogger(MdbFromNonDurableTopicWithOutQueueToContaniner1.class.getName());
