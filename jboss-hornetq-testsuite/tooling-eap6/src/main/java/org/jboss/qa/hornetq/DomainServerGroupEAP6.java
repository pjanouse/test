...
public class DomainServerGroupEAP6 implements DomainServerGroup {

    private static final Logger LOG = Logger.getLogger(DomainServerGroupEAP6.class);
    ...
    DomainServerGroupEAP6(String groupName, String hostname, int port, ContainerController containerController) {
        this.name = groupName;
    ...
    public JMSOperations getJmsOperations() {
        ...
        eap6AdmOps.addAddressPrefix("profile", profileName);
    ...
    public DomainNode node(String name) {
        return new DomainNodeEAP6(name, hostname, port, containerController);
    }
