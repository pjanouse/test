...
public class JmxUtils {
     ...
     * @throws IOException
     */
    public static JMXConnector getJmxConnectorForEap(final ContainerInfo container) throws IOException {
     ...
     * @throws IOException
     */
    public static JMXConnector getJmxConnectorForEap(final String host, final int port) throws IOException {
    ...
    public static HornetQServerControl getHornetQServerMBean(final MBeanServerConnection mbeanServer) throws Exception {
    ...
    public static JMSServerControl getJmsServerMBean(final MBeanServerConnection mbeanServer) throws Exception {
    ...
    public static Object getHornetQMBean(final MBeanServerConnection mbeanServer, final ObjectName mbeanName,
