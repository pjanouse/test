 ...
 */
public class JournalExportImportUtils {

    private static final Logger LOG = Logger.getLogger(JournalExportImportUtils.class);
     ...
     */
    public static boolean exportHornetQJournal(final ContainerInfo container, final String exportedFileName)
     ...
     * @throws InterruptedException
     */
    public static boolean importHornetQJournal(final ContainerInfo container, final String exportedFileName)
            throws IOException, InterruptedException {
