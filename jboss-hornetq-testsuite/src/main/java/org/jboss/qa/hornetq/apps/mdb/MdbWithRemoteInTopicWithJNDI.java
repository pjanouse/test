 ...
 * A MdbWithRemoteInTopicWithJNDI used for example lodh tests. Used in RemoteJcaWithRecoverTestCase in interop test suite.
 * <p/>
 ...
 */
@MessageDriven(name = "MdbWithRemoteInTopicWithJNDI",
        activationConfig = {
...
public class MdbWithRemoteInTopicWithJNDI implements MessageDrivenBean, MessageListener {
    ...
    private static final Logger log = Logger.getLogger(MdbWithRemoteInTopicWithJNDI.class.getName());
