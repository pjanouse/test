...
/**
 * A MdbAllHornetQActivationConfigTopic used for lodh tests.
 * <p/>
...
@MessageDriven(name = "mdb",
        activationConfig = {
                ...
                @ActivationConfigProperty(propertyName = "subscriptionName", propertyValue = "myDifferentSubscription"),
                @ActivationConfigProperty(propertyName = "clientID", propertyValue = "myDifferentClientId"),
...
//    private static Queue queue;
    ...
    private static final Logger log = Logger.getLogger(MdbAllHornetQActivationConfigTopic.class.getName());
    private MessageDrivenContext context = null;

    public MdbAllHornetQActivationConfigTopic() {
        super();
    }
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            log.log(Level.INFO, "MdbAllHornetQActivationConfigTopic- End of " + messageInfo + " in " + (System.currentTimeMillis() - time) + " ms");
