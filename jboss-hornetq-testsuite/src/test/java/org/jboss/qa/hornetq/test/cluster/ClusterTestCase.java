...
public class ClusterTestCase extends HornetQTestCase {
    ...
    private static final Logger log = Logger.getLogger(ProducerClientAckNonHA.class);
    ...
    String hostname_container1 = "127.0.0.1";
    String hostname_container2 = "127.0.0.2";
...
//        controller.start(CONTAINER2);
        ...
        ProducerClientAckNonHA producer = new ProducerClientAckNonHA(hostname_container1, queueName);
        
        producer.start();
        
        ReceiverClientAckNonHa receiver = new ReceiverClientAckNonHa(hostname_container1, queueName);
