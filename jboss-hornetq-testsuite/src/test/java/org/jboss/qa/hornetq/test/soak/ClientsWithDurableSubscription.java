...
public class ClientsWithDurableSubscription implements Runnable {
    ...
    @Override
    public void run() {
        log.info("Starting ClientsWithDurableSubscription clients ... ");
        ...
        log.info(String.format("Ending ClientsWithDurableSubscription clients %s ms", System.currentTimeMillis() - startTime));
    }
}
