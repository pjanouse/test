...
public class ColocatedSharedStoreHA extends TwoNodes {
    ...
    protected void afterPrepare(Map<String, Object> params, PrepareContext ctx) throws Exception {
        ...
        if (clusterType == Constants.CLUSTER_TYPE.STATIC_CONNECTORS) {
            ctx.invokeMethod("ColocatedSharedStoreHA-staticCluster", params);
        }
    ...
    @PrepareMethod(value = "ColocatedSharedStoreHA-staticCluster", labels = {"EAP6"})
    ...
    @PrepareMethod(value = "ColocatedSharedStoreHA-staticCluster", labels = {"EAP7"})
