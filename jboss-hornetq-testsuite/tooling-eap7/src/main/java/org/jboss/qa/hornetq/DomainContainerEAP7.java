...
@MetaInfServices
public class DomainContainerEAP7 implements DomainContainer {

    private static final Logger LOG = Logger.getLogger(DomainContainerEAP7.class);
    ...
    public HornetQTestCaseConstants.CONTAINER_TYPE getContainerType() {
        return HornetQTestCaseConstants.CONTAINER_TYPE.EAP7_DOMAIN_CONTAINER;
    }
    ...
    @Override
    public int getPort() {
        return Constants.MANAGEMENT_PORT_DEFAULT_EAP7;
    }
    ...
    public DomainServerGroup serverGroup(String groupName) {
        return new DomainServerGroupEAP7(groupName, getHostname(), getPort(), containerController);
    }
