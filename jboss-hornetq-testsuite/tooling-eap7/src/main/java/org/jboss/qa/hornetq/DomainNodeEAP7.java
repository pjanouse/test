...
public class DomainNodeEAP7 implements DomainNode {

    private static final Logger LOG = Logger.getLogger(DomainNodeEAP7.class);
    ...
    DomainNodeEAP7(String name, String hostname, int port, ContainerController containerController) {
        this.name = name;
    ...
    public JMSOperations getRuntimeJmsOperations() {
        ...
        eap7AdmOps.addAddressPrefix("host", "master");
        eap7AdmOps.addAddressPrefix("server", name);
