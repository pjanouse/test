...
import org.jboss.qa.hornetq.apps.clients20.XAConsumerTransAck;
 ...
 */
public class XAFailoverTestCase20 extends HornetQTestCase {


    private static final Logger logger = Logger.getLogger(XAFailoverTestCase20.class);
